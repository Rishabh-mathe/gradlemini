...
import com.oneshield.keymanager.KeyManager_IF;
import com.oneshield.keymanager.VaultKeyManager;
import com.oneshield.keymanager.KeyStatus;

public class VaultKeyManagerTest extends AbstractTestCase
{
	...
	{
		KeyManager_IF keyManager = new VaultKeyManager();
